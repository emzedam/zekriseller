<template>
  ...
  <div
    class="fixed top-0 left-0 z-50 w-full h-full transition-opacity duration-300 font-fa overflow-hidden hidden"
  >
    ...
    >
      ...
      <div class="modal-body font-fa mx-2 px-6 my-4">
        <p class="py-2 font-medium text-gray-700">
          کد ۵ رقمی به شماره‌ی ۰۹۰۳۰۲۶۴۳۰۰ ارسال گردید
        </p>
        <div class="gap-6">
          ...
          <div
            class="send-code-again w-full mx-auto text-center pb-4 text-gray-500 font-semibold"
          >
  ...
  <transition-group name="modal">
    <!-- ویرایش شماره موبایل -->
    <div
      v-if="activeModal == 'mobileNumberModal'"
